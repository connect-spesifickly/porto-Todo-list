...
export default function ProductOrService() {
  ...
  useEffect(() => {
    ...
    if (hash) {
      // Menghapus karakter "#" dan mendecode URL
              ...
              <div className="" key={idx} id={blog.fields.title}>
                <div>
                  <div className="relative isolate overflow-hidden bg-black px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-1">
                      ...
                      <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-[5vh]  lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                        <Image
                          ...
                          className="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] h-[30rem]"
                        />
                      </div>
                      <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                        <div className="lg:pr-4">
                          <div className="max-w-xl text-white lg:max-w-lg text-justify text-xl ">
                            <RichText document={blog.fields.body} />
                            <div className="text-[18px] pt-[40px] italic">
                              {blog.fields.testimony}
                            </div>
